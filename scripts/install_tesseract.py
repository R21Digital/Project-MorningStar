...
Please use: python scripts/dev/install_tesseract.py
"""
...
warnings.warn(
    "scripts/install_tesseract.py is deprecated. "
    "Please use: python scripts/dev/install_tesseract.py",
    DeprecationWarning,
    stacklevel=2
)
...
new_script_path = Path(__file__).parent / "dev" / "install_tesseract.py"
