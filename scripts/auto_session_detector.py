...
Please use: python scripts/dev/auto_session_detector.py
"""
...
warnings.warn(
    "scripts/auto_session_detector.py is deprecated. "
    "Please use: python scripts/dev/auto_session_detector.py",
    DeprecationWarning,
    stacklevel=2
)
...
new_script_path = Path(__file__).parent / "dev" / "auto_session_detector.py"
