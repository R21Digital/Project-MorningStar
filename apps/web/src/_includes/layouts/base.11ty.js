...
module.exports = function(data) {
  const { title = 'SWGDB - Star Wars Galaxies Database', content } = data;
...
<footer class="bg-black/80 border-t border-swg-cyan/50 py-12 relative z-10">
  <div class="max-w-6xl mx-auto px-6 text-center">
    ...
    <div class="border-t border-slate-700 pt-8 text-sm text-slate-500">
      <p>&copy; ${new Date().getFullYear()} SWGDB - Built with <span class="text-swg-red">❤️</span> by the Project MorningStar team</p>
