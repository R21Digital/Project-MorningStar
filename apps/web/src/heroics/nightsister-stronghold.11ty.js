// src/heroics/nightsister-stronghold.11ty.js
...
module.exports = class {
  data() {
    return {
      layout: 'base.11ty.js',
      title: 'Nightsister Stronghold - Heroic Guide',
      permalink: 'heroics/nightsister-stronghold/index.html',
    };
  }

  render() {
    const heroic = heroics.find(h => h.slug === 'nightsister-stronghold');
