// src/heroics/janta-blood-crisis.11ty.js
...
module.exports = class {
  data() {
    return {
      layout: 'base.11ty.js',
      title: 'Janta Blood Crisis - Heroic Guide',
      permalink: 'heroics/janta-blood-crisis/index.html',
    };
  }

  render() {
    const heroic = heroics.find(h => h.slug === 'janta-blood-crisis');
