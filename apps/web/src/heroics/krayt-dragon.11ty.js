// src/heroics/krayt-dragon.11ty.js
...
module.exports = class {
  data() {
    return {
      layout: 'base.11ty.js',
      title: 'Ancient Krayt Dragon - Heroic Guide',
      permalink: 'heroics/krayt-dragon/index.html',
    };
  }

  render() {
    const heroic = heroics.find(h => h.slug === 'krayt-dragon');
